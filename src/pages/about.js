      ...
      <Container>
        ...
        <article className="w-75 m-auto pt-2 text-justify">
          ...
          <p className="i-5 mt-4 pt-2">
            ...
            &nbsp;
            <b>{occupation}</b> discovering the ways of the code. I am intrested in reading mathematics stuff
            in my free time. Playing musical instruments, I currently can play little bit of Piano, Guitar, Kalimba.
          </p>
          <p className="i-5">
          </p>
          <p className="i-5">
